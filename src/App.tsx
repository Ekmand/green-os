...
function App() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'rgb(1, 4, 1)' }}>
      {/* Banner */}
      <div 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="-mt-32 relative z-10">
          <div className="flex flex-col items-center">
            ...
            <div className="flex gap-4 mt-8">
              <a
                ...
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-400 to-green-500 rounded-xl hover:translate-y-[-2px] transition-all duration-300 shadow-lg hover:shadow-green-500/25 text-white"
              >
                <Blocks size={20} />
          ...
          <div className="mt-16 mb-20">
            <div className="relative group">
              <div className="absolute -inset-1 bg-green-500 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex items-center gap-4 group">
              <div className="p-3 bg-black/50 rounded-xl border border-gray-700/50 group-hover:border-green-500/50 transition-colors duration-300">
                <Terminal size={32} className="text-green-500" />
              </div>
              <span className="text-2xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-green-500 to-emerald-500">
                OS Wars
              </span>
            </div>
            <div className="flex items-center gap-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 text-gray-400 hover:text-white bg-black/50 rounded-xl border border-gray-700/50 hover:border-green-500/50 transition-all duration-300 hover:scale-110"
              >
                <Globe size={24} />
              </a>
            </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-400 text-sm">
              Made with <span className="text-green-500">❤️</span> by the{' '}
              <span className="font-medium bg-clip-text text-transparent bg-gradient-to-r from-green-500 to-emerald-500">
                OS Wars Team
              </span>
            </p>
          </div>
